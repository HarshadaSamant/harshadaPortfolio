const portfolioData =  {
    ...
    "collegeExperience": "During my bachelor's degree course I learned about database system, web technologies, data structure, networking, business communication and programming languages.",
